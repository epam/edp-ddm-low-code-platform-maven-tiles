...
----
include::partial$puml/file-structure-intro-example.puml[file-structure intro-example]
----
...
----
include::partial$puml/file-structure-method-example.puml[file-structure method-example]
----
...
----
include::partial$puml/file-structure-snippets-example.puml[file-structure snippets-example]
----
...
----
include::partial$puml/file-structure-full-example.puml[file-structure full-example]
----